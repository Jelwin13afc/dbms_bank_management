...
if($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $c = mysqli_multi_query($con, "update register set firstname = '$firstname', lastname = '$lastname', email = '$email', phone = '$phone', address1 = '$address1', address2 = '$address2', city = '$city', state = '$state', country = '$country', father = '$father', nationality = '$nationality' where account_no = '$account_no'; update login set id = '$email' where account_no = '$account_no';");
...
<br><br>
<center>
  <div style="background-color: #4EB1BA; height: 45px; width: 100%; color: white; "><h1>Edit Profile</h1></div>
